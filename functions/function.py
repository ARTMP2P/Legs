...
def remove_noise(image):
    ...
    try:
        ...
        min_area = 15  # Минимальная площадь контура для удаления шумов (можно настроить)
        max_area = 150  # Максимальная площадь контура для удаления шумов (можно настроить)
